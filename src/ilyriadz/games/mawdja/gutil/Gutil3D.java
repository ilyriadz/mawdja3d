...
public final class Gutil3D 
{
    ...
    public static void initBoxFields(GameWorld3D gameWorld, double xpos, double ypos, 
        ...
        Image img, String name, String GroupName, Consumer<BoxObject> consumer)
    {
        ...
        for (int i = 0; i < field.length; i++) 
        {
            for (int j = 0; j < field[i].length; j++) 
            {
                ...
                var objName = name + (a++);
                gameWorld.addGameObject(GroupName, objName, field[i][j]);

                gameWorld.getGameGroup(GroupName).load(objName);
            } // end for
        } // end for
    }
    ...
    public static void initSphereFields(GameWorld3D gameWorld, double xpos, double ypos, 
        ...
        Image img, String name, String groupName, Consumer<SphereObject> consumer)
    {
    ...
    public static void initCylinderFields(GameWorld3D gameWorld, double xpos, double ypos, 
        ...
        Image img, String name, String groupName, Consumer<CylinderObject> consumer)
    {
