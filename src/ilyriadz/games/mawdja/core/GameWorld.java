...
public abstract class GameWorld
{
    ...
    private final Map<String, GameGroup> gamegroups = new HashMap<>();
    ...
    protected final void addGameObject(String gameGroupName, String gameObjectName,
        GameObject gameObject)
    {
        if (!gamegroups.keySet().contains(gameGroupName))
            gamegroups.put(gameGroupName, new GameGroup(gameManager, gameGroupName));
        gamegroups.get(gameGroupName).putGameObject(gameObjectName, gameObject);
    }
    
    protected final GameGroup getGameGroup(String gameGroupName)
    {
        if (!gamegroups.keySet().contains(gameGroupName))
    ...
    {
        gamegroups.values().forEach(GameGroup::creates);
    }
